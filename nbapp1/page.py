...
#官方推荐,页码数为奇数
class PageNation:
    def __init__(self,base_url,current_page_num,total_counts,request,per_page_counts=5,page_number=11,):
        '''
        ...
        if self.current_page_num > self.page_number_count and self.page_number_count!=0:
