# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2019-06-20 08:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nbapp1.ClassList', verbose_name='班级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, related_name='students', to='nbapp1.ClassList', verbose_name='已报班级')),
                ('customer', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='nbapp1.Customer', verbose_name='客户信息')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classstudyrecord', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nbapp1.ClassStudyRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nbapp1.Student', verbose_name='学员')),
            ],
        ),
